    ...
    def __init__(self):
        ...
        try:
            ...
            if not isinstance(query, dict):
                logger.warning(
                    "Could not find a 'query' dictionary in the caller's scope."
                )
                return
            ...
            logger.error(
                f"Failed to inspect caller context for logging: {e}", exc_info=True
            )
        finally:
                ...
                for generation in generation_list:
                    if hasattr(generation, "message") and hasattr(
                        ...
                        final_log = {
                            ...
                            "thoughts_token_count": usage_meta.get(
